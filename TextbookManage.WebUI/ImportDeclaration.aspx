                            ...
                            <MasterTableView>
                                <Columns>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="班级">
                                        <ItemTemplate>
                                            <cp:CPMisLinkButton ID="LinkShowClass" Text='<% #Eval("ClassName") %>' CommandName="ShowClass" runat="server"></cp:CPMisLinkButton>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                    <telerik:GridTemplateColumn HeaderText="书名" HeaderStyle-Width="120px">
                                        <ItemTemplate>
                                            <cp:CPMisLinkButton ID="LinkShowTextbook" Text='<% #Eval("TextbookName") %>' CommandName="ShowTextbook" runat="server"></cp:CPMisLinkButton>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
