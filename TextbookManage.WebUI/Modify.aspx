            ...
            <cp:CPMisMultiPage ID="MpTextbookManage" runat="server" SkinID="Auto">
                ...
                <cp:CPMisPageView ID="GdStudentImport" runat="server">
                    ...
                    <div id="div3" runat="server" style="padding-left: 5px; padding-top: 2px; text-align: left; background-color: #E1EBF7;">
                        <cp:CPMisLabel ID="CPMisLabel4" runat="server" Text="开课学院：" SkinID="AutoSize"></cp:CPMisLabel>&nbsp;&nbsp;
                        <cp:CPMisComboBox runat="server" ID="cmb_School" AutoPostBack="True"
                                DataTextField="School" DataValueField="SchoolID" DefaultIndex="0" IsCancelDataBind="False"
                                IsMaintainSelectedValue="False" SelectedText="" SkinID="btnLogin" >
                        </cp:CPMisComboBox>
                        <cp:CPMisLabel ID="CPMisLabel3" runat="server" Text="教研室：" SkinID="AutoSize"></cp:CPMisLabel>&nbsp;&nbsp;
                        <cp:CPMisComboBox runat="server" ID="cmb_Department" AutoPostBack="True"
                                DataTextField="Department" DataValueField="DepartmentID" DefaultIndex="0" IsCancelDataBind="False"
                                IsMaintainSelectedValue="False" SelectedText="" SkinID="btnLogin" >
                        </cp:CPMisComboBox>
